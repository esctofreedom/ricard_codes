export const SkillItem = ({name, description, logo}) => {
    ...
    return (
        ...
        <div className="hidden md:block group relative bg-white dark:bg-blueGray-800 shadow-md hover:shadow-lg rounded-md md:p-6 p-8 lg:p-4 mx-1 my-1">
            ...
            <h4 className="text-center text-blueGray-300 dark:text-blueGray-700  group-hover:text-blueGray-500
            transition ease-in-out transform group-hover:translate-x-6">
                {name}</h4>

            <div className="w-3/4 mx-auto transition ease-in-out transform group-hover:scale-50 
            group-hover:-translate-y-3/4 group-hover:-translate-x-1/2">
            {logo}
            </div>
            
            <div className="absolute top-0 mt-16 opacity-0 transition ease-in-out group-hover:opacity-100
